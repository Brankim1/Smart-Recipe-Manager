...
public class IngredientListRecyclerAdapter extends RecyclerView.Adapter<IngredientListRecyclerAdapter.ViewHolder> {
    ...
    public boolean bacon,beef,bread, cheese,carrot,chicken,cucumber,duck,egg,fish,flour,honey,lamb,lemon,milk,mushroom,nuts,pork,potato,rice,salmon,tofu,tomato,wine=false;
